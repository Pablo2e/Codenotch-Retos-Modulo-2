...
app.put('/profesionales/:id', function (request, response) {
    ...
    //arrayPro.push(pNuevo)
    var respuesta = { error: false, codigo: 200, Mensaje: 'Profesional Actualizado', resultado: arrayPro[id - 1] };
    response.send(respuesta);
});
app["delete"]('/profesionales/:id', function (request, response) {
    ...
    //arrayPro.push(pNuevo)
    var respuesta = { error: false, codigo: 200, Mensaje: 'Profesional Borrado', pNuevo: pNuevo };
    response.send(respuesta);
});
...
var p1 = new professional_1.Professional("Julia Roberts", 40, "female", 60, 170, "brown", "blue", "caucasian", "no", "USA", 2, "actress", "http//:foto.jpg");
var p2 = new professional_1.Professional("Halle Berry", 30, "female", 57, 174, "black", "brown", "african-american", "yes", "Canadian", 2, "http//:foto.jpg", "http//:foto.jpg");
var p3 = new professional_1.Professional("Paul Williams", 30, "male", 80, 170, "brown", "blue", "caucasian", "yes", "USA", 2, "actor", "http//:foto.jpg");
var p4 = new professional_1.Professional("Mario Guevara", 30, "male", 80, 180, "brown", "blue", "hispanic", "yes", "Mexican", 2, "actor", "http//:foto.jpg");
var p5 = new professional_1.Professional("Xing Xung", 25, "male", 80, 180, "black", "brown", "asian", "yes", "China", 0, "actor", "http//:foto.jpg");
