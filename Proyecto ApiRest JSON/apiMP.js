...
app.post('/peliculas', function (request, response) {
    ...
    var respuesta = { error: false, codigo: 200, Mensaje: 'Pelicula Agregada', resultado: pNueva };
    response.send(respuesta);
});
//Put
...
var arrayMov = (JSON.parse(lecturaM)); //creo un objeto del string leido en lectura
