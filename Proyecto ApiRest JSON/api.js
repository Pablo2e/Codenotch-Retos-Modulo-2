...
var ficheroPro = "profesionales.json";
var pNuevo = null;
...
app.post('/profesionales', function (request, response) {
    ...
    escribirEnFicheroJSON(arrayPro, ficheroPro);
...
var lectura = fs.readFileSync(ficheroPro, 'utf8'); //leo el fichero y lo convierto a texto
var arrayPro = (JSON.parse(lectura)); //creo un objeto del string leido en lectura
