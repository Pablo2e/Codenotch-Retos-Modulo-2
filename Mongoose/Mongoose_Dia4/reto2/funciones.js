...
/*  function obtenerFotos(usuario, response){
...
function obtenerTimeline(usuario, response){
    User.findOne({_id: usuario})
    .populate('photos') 
    .populate('follow')
    .exec(function(err,usuario){
...
module.exports = {subirFoto, obtenerFoto, seguir, dejarDeSeguir, eliminarFoto, eliminarTodasLasFotos, checkRespuesta,obtenerFotos,obtenerTimeline}
